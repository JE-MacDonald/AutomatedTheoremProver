...
/* package AutomatedTheoremProver-0.1.0.0 */
#ifndef VERSION_AutomatedTheoremProver
#define VERSION_AutomatedTheoremProver "0.1.0.0"
#endif /* VERSION_AutomatedTheoremProver */
#ifndef MIN_VERSION_AutomatedTheoremProver
#define MIN_VERSION_AutomatedTheoremProver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_AutomatedTheoremProver */
...
#define CURRENT_COMPONENT_ID "AutomatedTheoremProver-0.1.0.0-inplace-project"
